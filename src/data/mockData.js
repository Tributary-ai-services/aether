...
export const communityItems = [
  ...
  { type: "workflow", name: "GDPR Compliance Flow", author: "CompliancePro", downloads: 567, rating: 4.9, description: "Automated GDPR compliance scanning for uploaded documents with PII detection and reporting.", step_count: 4, trigger_types: ["api", "schedule"], workflow_type: "compliance_check" },
  ...
  { type: "workflow", name: "Document Classification Pipeline", author: "AI Solutions", downloads: 789, rating: 4.7, description: "Classify documents by type using AI analysis, then route to appropriate processing pipelines.", step_count: 3, trigger_types: ["upload", "webhook"], workflow_type: "document_processing" },
...
export const mockSkills = [
  {
    ...
    display_name: "Visual Generation",
    description: "Generate diagrams, mind maps, flowcharts, and visual content from text descriptions using Napkin AI",
    type: "mcp",
    icon: "Image",
    tags: ["visual", "diagram", "chart", "mindmap", "napkin"],
    keywords: ["visual", "diagram", "chart", "graph", "mindmap", "infographic", "illustration", "draw", "flowchart"],
    mcp_server_url: "http://napkin-mcp.tas-mcp-servers.svc.cluster.local:8087",
    mcp_tool_names: ["generate_visual", "list_styles", "get_visual_status", "download_visual", "list_visuals", "delete_visual"],
    is_public: true,
    is_system: true,
    author: "TAS Platform",
    version: "1.0.0",
  },
  {
    ...
    description: "Search and retrieve documents from notebooks using semantic vector search",
    type: "mcp",
    icon: "Search",
    tags: ["search", "documents", "vector", "semantic"],
    keywords: ["search", "find", "query", "lookup", "document", "retrieve"],
    is_public: true,
    is_system: true,
    author: "TAS Platform",
    version: "1.0.0",
  },
  {
    ...
    keywords: ["code", "execute", "run", "program", "script", "python"],
    is_public: true,
    is_system: false,
    author: "TAS Platform",
    version: "0.9.0",
